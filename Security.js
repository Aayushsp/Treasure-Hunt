class Security {
    ...
    constructor(){
        ...
        this.access2.position(640,190);
        this.access2.style('background', 'white');  

        this.button2 = createButton('Check');
        this.button2.position(640,220);
...
//add code for creating and positioning the third input box and button
    ...
    display(){
        ...
        this.button1.mousePressed(() => {
            ...
            if (system.false(accessCode1, this.access1.value())) {
                negative.play();
            }
        });
        ...
        this.button2.mousePressed(() => {
            ...
            if (system.false(accessCode2, this.access2.value())) {
                negative.play();
            }
        });
//add code for what happens when the third button is pressed
        this.button3.mousePressed(() => {
            ...
            if (system.false(accessCode3, this.access3.value())) {
                negative.play();
            }
        })
